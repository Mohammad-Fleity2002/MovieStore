...
namespace Movies.Repositories.Implementation
{
	public class UserAuthenticationService: IUserAuthenticationService
	{
        ...
        public UserAuthenticationService(UserManager<Users> userManager,
        ...
        public async Task<Status> LoginAsync(LoginModel model)
        {
            ...
            var signInResult = await signInManager.PasswordSignInAsync(user, model.Password,true,true) ;//replace first bool val with false to get less cookies time
